...
function setup() {
  ...
  var enterpriseServer = _ref.enterpriseServer,
      opts = _objectWithoutProperties(_ref, ['enterpriseServer']);

  var sdkServer = opts.sdkServer || enterpriseServer;
  var ingestServer = opts.ingestServer || enterpriseServer;
  ...
  var instance = (0, _makeLogRocket2.default)(function () {
    ...
    if (sdkServer) {
      ...
      script.src = undefined === 'staging' ? 'https://cdn-staging.logrocket.io/logger.min.js' : 'https://cdn.logrocket.io/logger.min.js';
    }
    ...
    script.onload = function () {
      instance.onLogger(new window._LRLogger({
        sdkVersion: "0.6.20" // eslint-disable-line no-undef
      }));
    };
...
var _registerFetch = __webpack_require__(13);
...
var _fetchIntercept = __webpack_require__(14);
...
var _raven = __webpack_require__(16);
...
var _registerConsole = __webpack_require__(19);
